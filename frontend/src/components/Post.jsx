  ...
  return (
    <div className='w-[90%]   flex flex-col gap-[10px] bg-white items-center shadow-2xl shadow-[#00000058] rounded-2xl pb-[20px]'>
      <div className='w-full h-[80px] flex justify-between items-center px-[10px]'>
       ...
       {userData._id!=post.author._id &&  <FollowButton tailwind={'px-[10px] minw-[60px] md:min-w-[100px] py-[5px] h-[30px] md:h-[40px] bg-gradient-to-r from-black via-blue-700 to-black text-white rounded-[7px] text-[14px] md:text-[16px]'} targetUserId={post.author._id}/>}
      ...
      <div className='w-full h-[60px] flex justify-between items-center px-[20px] mt-[10px]'>
        <div className='flex justify-center items-center gap-[10px] '>
          <div className='flex justify-center items-center gap-[5px]'>
            ...
            {post.likes.includes(userData._id) && <GoHeartFill className='w-[25px] cursor-pointer h-[25px] text-blue-700' onClick={handleLike}/>}
