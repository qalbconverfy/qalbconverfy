...
function Nav() {
  ...
  return (
    <div className='w-[100%] lg:w-[40%] h-[80px] bg-gradient-to-r from-black via-blue-700 to-black flex justify-around items-center fixed bottom-[0px] rounded-[15px] shadow-2xl shadow-[#000000] z-[100]'>
