...
function ReceiverMessage({message}) {
  ...
  return (
    <div ref={scroll} className='w-fit max-w-[60%] rounded-t-[10px] rounded-br-[10px] rounded-bl-0 px-[10px] py-[10px] relative left-0 flex flex-col gap-[10px]' style={{ backgroundImage: 'url(/bgi.png)', backgroundSize: 'fixed', backgroundPosition: 'center' }}>
