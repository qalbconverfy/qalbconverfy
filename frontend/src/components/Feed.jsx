...
function Feed() {
  ...
  return (
    <div className='lg:w-[50%] w-full min-h-[100vh] lg:h-[100vh] relative lg:overflow-y-auto' style={{ backgroundImage: 'url(/bgi.png)', backgroundSize: 'fixed', backgroundPosition: 'center' }}>
...
<div className='w-full min-h-[100vh] flex flex-col items-center gap-[20px] p-[10px] pt-[40px]  bg-white rounded-t-[12px] relative pb-[120px]'>
