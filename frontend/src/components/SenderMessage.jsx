...
scroll.current.scrollIntoView({behavior:"smooth"})
  ...
  return (
    <div ref={scroll} className='w-fit max-w-[60%] bg-gradient-to-br from-[#9500ff] to-[#ff0095] rounded-t-[10px] rounded-bl-[10px] rounded-br-0 px-[10px] py-[10px] relative ml-auto right-0 flex flex-col gap-[10px]'>
