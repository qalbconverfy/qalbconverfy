...
function Search() {
 ...
 <div className='w-[90%] max-w-[800px] h-[80%] rounded-full bg-transparent flex items-center px-[20px]' >
...
<div className='w-[90vw] max-w-[700px] h-[60px] rounded-[10px] bg-transparent flex items-center gap-[20px] px-[5px] cursor-pointer border-1 border-white hover:bg-transparent' onClick={()=>navigate(`/profile/${user.userName}`)}>
<div className='w-[50px] h-[50px] border-2 border-black rounded-full cursor-pointer overflow-hidden' >
      ...
      <div className='text-white text-[18px] font-semibold'>
        <div>{user.userName}</div>
           <div className='text-[14px] text-green-600'>{user.name}</div>
      </div>
...
{!input && <div className='text-[30px] text-white font-bold'>Search Here...</div>}
