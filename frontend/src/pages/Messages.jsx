...
const dispatch=useDispatch()
  return (
    ...
    <div className='w-full min-h-[100vh] flex flex-col gap-[20px] p-[10px]' style={{ backgroundImage: 'url(/bgi.png)', backgroundSize: 'fixed', backgroundPosition: 'center' }}>
       <div className='w-full h-[80px]  flex items-center gap-[20px] px-[20px]'>
                  ...
                  <div className='w-full h-[80px] flex gap-[20px] justify-start items-center overflow-x-auto p-[20px] border-b-2 border-gray-200'>
